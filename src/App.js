...
function App() {
  ...
  {/* <!-- Page Wrapper --> */}
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <Link to="/Login" className="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div className="sidebar-brand-icon rotate-n-15">
                    <i className="fas fa-laugh-wink"></i>
                </div>
                <div className="sidebar-brand-text mx-3">Login<sup>2</sup></div>
            </Link>
            {/* <!-- Divider --> */}
            ...
            <li className="nav-item">
                ...
                <div id="collapsePages" className="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div className="bg-white py-2 collapse-inner rounded">
                        ...
                        <Link to="/register" className="collapse-item" >Register
                        </Link>
